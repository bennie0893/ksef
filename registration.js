...
async function deleteRow(sheetName, rowIndex) {
  try {
    ...
    const response = await fetch("http://ksef-10.onrender.com/delete", {
      method: "POST",
...
function saveChanges(sheetRange, updatedData) {
  fetch("http://ksef-10.onrender.com/update", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
document
  ...
  .addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch("http://ksef-10.onrender.com/add-project", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
document.getElementById("uploadButton").addEventListener("click", function () {
  ...
  fetch("http://ksef-10.onrender.com/upload-excel", {
    method: "POST",
    body: formData,
  })
    .then((response) => {
